...
tags:
  ...
  - Charts
---
Recently, I came across the popular site which is famous for Node.js blogging and they published a blog on [Generating PDF from HTML with Node.js and Puppeteer](https://blog.risingstack.com/pdf-from-html-node-js-puppeteer/) one month ago. This blog talks about the challenges which a Node.js developer face during Pdf generation. We also faced the similar issue while generating pdf eight months ago and problem was solved using puppetter library. There was one more challenge, where we had to generate dynamic report with some analytic data. 
